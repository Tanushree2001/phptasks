...
<body>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
    ...
    echo($fullname); ?>"><br>
    Add Image: <input type="file" name="img_upload" required accept=".jpg,.jpeg,.png">  <br> <!--File image-->
    Marks: <textarea name="marks" rows="5" cols="50" ></textarea>   
    Mobile_num: <input type="text" value="+91" name="mobile_no" maxlength="13"> <!--Mobile number-->
    <br>
    <br>
  ...
  echo "Hello " . $fullname;  
  if(preg_match("/^\+91[0-9]{10}$/", $mob_num)){
    echo ($mob_num);
  }
  ?>
  <table border="1">
